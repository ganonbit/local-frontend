            ...
            <ul className="widget w-friend-pages-added notification-list friend-requests">
                <li className="inline-items">
                    ...
                    <div className="notification-event">
                        <a href="#1" className="h6 notification-friend">Francine Smith</a>
                ...
                <li className="inline-items">
                    ...
                    <div className="notification-event">
                        <a href="#1" className="h6 notification-friend">Hugh Wilson</a>
                ...
                <li className="inline-items">
                    ...
                    <div className="notification-event">
                        <a href="#1" className="h6 notification-friend">Karen Masters</a>
                        <span className="chat-message-item">6 Friends in Common</span>
                    </div>
                    <span className="notification-icon">
                        <a href="#1" className="accept-request">
