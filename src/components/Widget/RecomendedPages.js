            ...
            <ul className="widget w-friend-pages-added notification-list friend-requests">
                <li className="inline-items">
                    ...
                    <div className="notification-event">
                        <a href="#1" className="h6 notification-friend">The Marina Bar</a>
                ...
                <li className="inline-items">
                    ...
                    <div className="notification-event">
                        <a href="#1" className="h6 notification-friend">Tapronus Rock</a>
                ...
                <li className="inline-items">
                    ...
                    <div className="notification-event">
                        <a href="#1" className="h6 notification-friend">Pixel Digital Design</a>
                ...
                <li className="inline-items">
                    ...
                    <div className="notification-event">
                        <a href="#1" className="h6 notification-friend">Thompson’s Custom Clothing Boutique</a>
                ...
                <li className="inline-items">
                    ...
                    <div className="notification-event">
                        <a href="#1" className="h6 notification-friend">Crimson Agency</a>
                        <span className="chat-message-item">Company</span>
                    </div>
                    <span className="notification-icon" data-toggle="tooltip" data-placement="top"
                        data-original-title="ADD TO YOUR FAVS">
                ...
                <li className="inline-items">
                    ...
                    <div className="notification-event">
                        <a href="#1" className="h6 notification-friend">Mannequin Angel</a>
                        <span className="chat-message-item">Clothing Store</span>
                    </div>
                    <span className="notification-icon" data-toggle="tooltip" data-placement="top"
                        data-original-title="ADD TO YOUR FAVS">
