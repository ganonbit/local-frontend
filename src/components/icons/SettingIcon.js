...
export const SettingIcon = ({ width, color }) => {
  ...
  return (
    ...
    >
      ...
      />
      <path d='M9,13.9c-2.7,0-4.9-2.2-4.9-4.9c0-2.7,2.2-4.9,4.9-4.9c2.7,0,4.9,2.2,4.9,4.9C13.9,11.7,11.7,13.9,9,13.9z M4.8,9c0,2.3,1.9,4.2,4.2,4.2c2.3,0,4.2-1.9,4.2-4.2c0-2.3-1.9-4.2-4.2-4.2C6.7,4.8,4.8,6.7,4.8,9z' />
    </svg>
  );
};
