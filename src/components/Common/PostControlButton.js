  ...
  return (
    <div className='control-block-button post-control-button'>
      {!isAuth ? (
        ...
        >
          <img
            src='https://res.cloudinary.com/weare270b/image/upload/q_auto/v1575849612/static/heart-icon_jd2hne.png'
            alt=''
          />
      ...
      {!isAuth ? (
        ...
        >
          <img
            src='https://res.cloudinary.com/weare270b/image/upload/q_auto/v1575849612/static/comments-icon_ffpa0l.png'
            alt=''
          />
          <div className='ripple-container'></div>
        </a>
