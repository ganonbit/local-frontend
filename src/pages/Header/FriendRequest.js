...
import { faSmile, faAngry, faEllipsisV } from '@fortawesome/free-solid-svg-icons'
const FriendRequest = () => {
    return (
        <div className="control-icon more has-items">
            ...
            <div className="more-dropdown more-with-triangle triangle-top-center">
                    ...
                    <ul className="notification-list friend-requests">
                        <li>
                            ...
                            <div className="notification-event">
                                <a href="#1" className="h6 notification-friend">Tamara Romanoff</a>
                        ...
                        <li>
                            ...
                            <div className="notification-event">
                                <a href="#1" className="h6 notification-friend">Tony Stevens</a>
                        ...
                        <li className="accepted">
                            ...
                            <div className="notification-event">
                                You and <a href="#1" className="h6 notification-friend">Mary Jane Stark</a> just
										became friends. Write on <a href="#1" className="notification-link">her wall</a>.
									</div>
                            <span className="notification-icon">
                                <svg className="olymp-happy-face-icon">
                        ...
                        <li>
                            ...
                            <div className="notification-event">
                                <a href="#1" className="h6 notification-friend">Stagg Clothing</a>
                ...
                <a href="#1" className="view-all bg-blue">Check all your Events</a>
            </div >
        </div >)
