          ...
          <div className='col col-xl-6 col-lg-8 col-md-12 col-sm-12 col-12 m-auto'>
            <div className='row'>
              <div className='col-xl-6 col-lg-6 col-md-6 mb-4'>
                <h2>Welcome to Local Social,</h2>
                <p>
                  {' '}
                  a one of a kind social network with rewards for local fans.
                </p>
                <p>
                  We’ve hand selected some of the best local content out there
                  to inspire your next lunch, dinner party or appetizer and we
                  want to see your local masterpieces too!
                </p>
                <p>
                  So join today and start earning points for the pics you’re
                  already taking and the thing you’re already sharing.
                </p>
              </div>
            ...
            <div className='row d-flex justify-content-center align-items-center'>
              ...
              <div className='col-lg-2 col-md-2 col-sm-2 col-3 px-2'>
                ...
                >
                  <LazyLoadImage
                    className='mw-100'
                    src='https://res.cloudinary.com/hylian/image/upload/f_auto,q_auto/v1580838540/static/video-play-btn_sxo2c1-min_urt5rb.png'
                    alt=''
                  />
                </a>
              </div>
