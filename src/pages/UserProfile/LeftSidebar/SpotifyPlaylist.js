      ...
      <ol className='widget w-playlist'>
        <li className='js-open-popup' data-popup-target='.playlist-popup'>
          <div className='playlist-thumb'>
            <img
              src='https://res.cloudinary.com/weare270b/image/upload/v1575849612/static/playlist6.jpg'
        ...
        <li className='js-open-popup' data-popup-target='.playlist-popup'>
          <div className='playlist-thumb'>
            <img
              src='https://res.cloudinary.com/weare270b/image/upload/v1575849612/static/playlist7.jpg'
              alt='thumb-composition'
            />
            <div className='overlay'></div>
            <a href='#' className='play-icon'>
        ...
        <li className='js-open-popup' data-popup-target='.playlist-popup'>
          <div className='playlist-thumb'>
            <img
              src='https://res.cloudinary.com/weare270b/image/upload/v1575849612/static/playlist8.jpg'
              alt='thumb-composition'
            />
            <div className='overlay'></div>
            <a href='#' className='play-icon'>
        ...
        <li className='js-open-popup' data-popup-target='.playlist-popup'>
          <div className='playlist-thumb'>
            <img
              src='https://res.cloudinary.com/weare270b/image/upload/v1575849612/static/playlist9.jpg'
              alt='thumb-composition'
            />
            <div className='overlay'></div>
            <a href='#' className='play-icon'>
        ...
        <li className='js-open-popup' data-popup-target='.playlist-popup'>
          <div className='playlist-thumb'>
            <img
              src='https://res.cloudinary.com/weare270b/image/upload/v1575849612/static/playlist10.jpg'
              alt='thumb-composition'
            />
            <div className='overlay'></div>
            <a href='#' className='play-icon'>
